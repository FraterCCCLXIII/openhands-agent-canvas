...
const IDENTICAL_VALUE_ALLOWLIST = new Set([
  ...
  'LOOPS$EMPTY',
  'LOOPS$EMPTY_HINT',
  'LOOPS$CREATE_FROM_TEMPLATE',
  'LOOPS$TEMPLATES_TITLE',
  'LOOPS$YOUR_LOOPS',
  'LOOPS$CREATE_MODAL_TITLE',
  'LOOPS$CREATE_MODAL_DESCRIPTION',
  'LOOPS$CREATE_NAME_LABEL',
  'LOOPS$CREATE_SUBMIT',
  'LOOPS$CREATING',
  'LOOPS$CREATE_SUCCESS',
  'LOOPS$RUN_TURN_NOW',
  'LOOPS$RUNNING_TURN',
  'LOOPS$RUN_TURN_SUCCESS',
  'LOOPS$STATUS_ACTIVE',
  'LOOPS$STATUS_PAUSED',
  'LOOPS$INBOX_COUNT',
  'LOOPS$MOVE_DISCOVERY',
  'LOOPS$MOVE_HANDOFF',
  'LOOPS$MOVE_VERIFICATION',
  'LOOPS$MOVE_PERSISTENCE',
  'LOOPS$MOVE_SCHEDULING',
  'LOOPS$TEMPLATE_MORNING_TRIAGE_NAME',
  'LOOPS$TEMPLATE_MORNING_TRIAGE_DESCRIPTION',
  'LOOPS$TEMPLATE_MORNING_TRIAGE_PHASE',
  'LOOPS$BACK_TO_LIST',
  'LOOPS$NOT_FOUND',
  'LOOPS$DELETE',
  'LOOPS$DELETE_SUCCESS',
  'LOOPS$MOVES_TITLE',
  'LOOPS$DISCOVERY_SKILL',
  'LOOPS$STATE_FILE',
  'LOOPS$STOP_CONDITION',
  'LOOPS$SCHEDULE',
  'LOOPS$RUN_HISTORY',
  'LOOPS$NO_RUNS',
  'LOOPS$RUN_TURN_LABEL',
  'LOOPS$RUN_FINDINGS',
]);
