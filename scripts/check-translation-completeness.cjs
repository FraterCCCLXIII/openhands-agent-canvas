...
const IDENTICAL_VALUE_ALLOWLIST = new Set([
  ...
  'SETTINGS$PAGE_INTEGRATIONS_SUBLINE',
  ...
  'APPS$HUB_TITLE',
  'APPS$HUB_DESCRIPTION',
  'APPS$ODYSSEUS_TITLE',
  'APPS$CATALOG_TITLE',
  'APPS$SCOPE_PRODUCT',
  'APPS$SCOPE_WORK',
  'APPS$ODYSSEUS_MISSING_FIELDS',
  'APPS$ODYSSEUS_CONNECTED',
  'APPS$ODYSSEUS_CONNECT_FAILED',
  'APPS$ODYSSEUS_HELP',
  'APPS$ODYSSEUS_URL',
  'APPS$ODYSSEUS_TOKEN',
  'APPS$ODYSSEUS_TESTING',
  'APPS$ODYSSEUS_TEST',
  'APPS$MEMORY_ENABLED',
  'APPS$MEMORY_INJECT',
  'APPS$MEMORY_DESCRIPTION',
  'APPS$NOTES_DESCRIPTION',
  'APPS$EMAIL_DESCRIPTION',
  'APPS$CALENDAR_DESCRIPTION',
  'APPS$CONTACTS_DESCRIPTION',
  'APPS$DOCUMENTS_DESCRIPTION',
  'APPS$RESEARCH_DESCRIPTION',
  'APPS$SCHEDULED_TASKS_DESCRIPTION',
  'APPS$MEMORY_LABEL',
  'APPS$NOTES_LABEL',
  'APPS$EMAIL_LABEL',
  'APPS$CALENDAR_LABEL',
  'APPS$CONTACTS_LABEL',
  'APPS$DOCUMENTS_LABEL',
  'APPS$RESEARCH_LABEL',
  'APPS$SCHEDULED_TASKS_LABEL',
  'APPS$BROWSER_LABEL',
]);
