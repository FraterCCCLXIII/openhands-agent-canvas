...
export function Tools() {
  ...
  return (
    <div className="relative">
      <button
        type="button"
        className="group flex items-center gap-1 rounded-[100px] border border-transparent px-1.5 text-[#959CB2] transition-[border-color,color] cursor-pointer hover:border-[#4B505F] hover:text-white"
        onClick={handleClick}
      >
        <Wrench
