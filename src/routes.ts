...
export default [
  layout("routes/root-layout.tsx", [
    ...
    route("settings", "routes/settings.tsx", [
      ...
      route("hooks", "routes/hooks-settings.tsx"),
      route("code-style", "routes/code-style-settings.tsx"),
    ...
    route("code-review", "routes/code-review.tsx", [
      index("routes/code-review-index.tsx"),
      route("pull-requests", "routes/code-review-pull-requests.tsx"),
      route("hooks", "routes/code-review-hooks.tsx"),
      route("code-style", "routes/code-review-code-style.tsx"),
      route("issues", "routes/code-review-issues.tsx"),
    ]),
  ]),
  route(
