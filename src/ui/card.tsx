...
const cardVariants = cva("flex", {
  variants: {
    theme: {
      default: "relative bg-[var(--oh-surface)] border border-[var(--oh-border-input)] rounded-xl",
      outlined: "relative bg-transparent border border-[var(--oh-border-input)] rounded-xl",
